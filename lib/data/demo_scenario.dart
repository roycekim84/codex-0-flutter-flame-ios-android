class DemoScenario {
  static Map<String, dynamic> create() {
    ...
    // Scenario-owned territory shapes are data, not renderer geometry. They
    // are deliberately irregular so ownership reads as regions on the map,
    // while the background map remains an independent terrain layer.
    final territoryPolygons = [
      [[0.00, 0.00], [0.34, 0.00], [0.39, 0.16], [0.31, 0.35], [0.13, 0.39], [0.00, 0.30]],
      [[0.34, 0.00], [0.65, 0.00], [0.70, 0.17], [0.58, 0.35], [0.39, 0.16]],
      [[0.65, 0.00], [1.00, 0.00], [1.00, 0.29], [0.79, 0.35], [0.70, 0.17]],
      [[0.79, 0.35], [1.00, 0.29], [1.00, 0.63], [0.75, 0.72], [0.58, 0.48]],
      [[0.30, 0.72], [0.48, 0.54], [0.58, 0.48], [0.75, 0.72], [0.70, 1.00], [0.34, 1.00]],
      [[0.00, 0.58], [0.14, 0.50], [0.21, 0.66], [0.18, 0.80], [0.00, 0.78]],
      [[0.00, 0.30], [0.13, 0.39], [0.31, 0.35], [0.39, 0.54], [0.30, 0.72], [0.21, 0.66], [0.14, 0.50], [0.00, 0.58]],
      [[0.39, 0.16], [0.58, 0.35], [0.58, 0.48], [0.48, 0.54], [0.39, 0.54], [0.31, 0.35]],
      [[0.70, 0.17], [0.79, 0.35], [0.58, 0.48], [0.58, 0.35]],
      [[0.75, 0.72], [1.00, 0.63], [1.00, 1.00], [0.70, 1.00]],
      [[0.00, 0.78], [0.18, 0.80], [0.30, 0.72], [0.34, 1.00], [0.00, 1.00]],
      [[0.79, 0.00], [1.00, 0.00], [1.00, 0.29], [0.79, 0.35], [0.86, 0.20]],
    ];
    final adj = [
      ['p_briar', 'p_ford'],
      ['p_ash', 'p_crown', 'p_elm'],
    ...
    for (var i = 0; i < provinceIds.length; i++) {
      provinces.add({
        ...
        'food': 600 + i * 100,
        'floodControl': 25 + i * 3,
        'territoryPoints': territoryPolygons[i],
